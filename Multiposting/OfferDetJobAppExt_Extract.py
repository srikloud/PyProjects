...
def lod_jobreqdets():
    ...
    error_file = open('C:/Users/C5259095/Downloads/Multiposting/MP_OUTPUT/error_OfferDetJobAppEx.csv', 'w', encoding="utf-8")
    ...
    for file in os.listdir(directory):
        ...
        #print(filename)
        if (filename.endswith("AES_OfferDetJobAppExt.csv")) and ('test' not in filename.lower()) and ('perf' not in filename.lower()):
